      ...
      case EActionType.SET_THEME:
        return {
          ...
          theme: { 
            ...
            styles: {
              gradient: selectedGradientThemeStyles[payload.theme.type] ?? 'bg-zinc-900', 
              background: selectedBackgroundThemeStyles[payload.theme.type] ?? 'bg-zinc-900', 
              text: selectedTextThemeStyles[payload.theme.type] ?? 'text-zinc-100'
            }
          } ,
        };
  }
